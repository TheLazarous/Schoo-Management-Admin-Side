...
function saveSubject() {
    ...
    if (s.value.toString().length == 0) {
        alert("Subject Category is Required", "danger");
    ...
    if (p.value.toString().length == 0) {
        alert("Subject level is Required", "danger");
        var r = document.getElementById("retry");
        r.setAttribute("style", "display:all");
    ...
    var p = document.getElementById("teacher_id");

    if (p.value.toString().length == 0) {
        alert("Teacher is Required", "danger");
        var r = document.getElementById("retry");
        r.setAttribute("style", "display:all");
    ...
    var we = document.getElementById("name");
    if (we.value.toString().length == 0) {
        alert("Subject Name is Required", "danger");
        var r = document.getElementById("retry");
        r.setAttribute("style", "display:all");
   ...
   data= JSON.stringify(jsonDataObj);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            alert('Subject Saved Successfully ', 'success');
            return
...
function getTeachers() {
    $.ajax({
        url: '/api/v1/teacher/getTeachers',
        type: 'GET',
        success: function (response) {
            let items = response;
            console.log(response);
            ...
            var t_body = document.getElementById("teacher_id");
            ...
            for (let i = 0; i < items.length; i++) {
                let html = `${items[i].firstName + " " + items[i].lastName}`;
